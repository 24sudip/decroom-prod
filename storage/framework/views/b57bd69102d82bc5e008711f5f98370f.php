    ...
    <div class="container py-5">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <button type="button" class="btn btn-primary d-block d-sm-none" data-bs-toggle="modal" data-bs-target="#exampleModal">
                  Full Screen
                </button>
                    ...
                    <div class="modal-dialog modal-xl modal-fullscreen-sm-down">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Click on Right Side to Close</h1>
                            ...
                            <div class="modal-body" id="modalBody">
                                <div class="modern-chat-container" id="cardContent">
                                    ...
                                    <div class="chat-sidebar">
                                        ...
                                        <div class="chat-list">
                                            <?php $__currentLoopData = $chatlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="chat-list-item <?php echo e(isset($sellerInfo) && $sellerInfo->id == $value->id ? 'active' : ''); ?>"
                                                     onclick="redirectToChat(<?php echo e($value->id); ?>)">
                                                    <div class="chat-avatar">
                                                        <img src="<?php echo e(asset($value->logo)); ?>" alt="logo" />
                                                    </div>
                                                    <div class="chat-info">
                                                        <div class="chat-shop-name"><?php echo e($value->shop_name); ?></div>
                                    ...
                                    <!-- Chat Area -->
                                    <div class="chat-area">
                                        <?php if(isset($cmessages)): ?>
                                            <div class="chat-header p-3 border-bottom d-flex align-items-center">
                                                <div class="chat-header-avatar me-3">
                                                    <img src="<?php echo e(asset($sellerInfo->vendorDetails->logo)); ?>" alt="logo" />
                                                </div>
                                                <div class="chat-header-info">
                                                    <a href="<?php echo e(route('vendor.shop.view', $sellerInfo->id)); ?>">
                                                        <h6 class="mb-0"><?php echo e($sellerInfo->vendorDetails->shop_name); ?></h6>
                                                    </a>
                                            ...
                                            <div class="chat-messages p-3" id="messageBottom">
                                                <?php $__currentLoopData = $cmessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="message <?php echo e($value->isCustomer != null ? 'sent' : 'received'); ?>">
                                                        <div class="message-content">
                                                            <?php if($value->file): ?>
                                                                <div class="file-preview">
                                                                    ...
                                                                    <div class="file-info">
                                                                        <!--<div class="file-name"><?php echo e(basename($value->file)); ?></div>-->
                                                            ...
                                                            <?php if($value->message): ?>
                                                                <div class="message-bubble">
                                                                    <div class="message-text"><?php echo e($value->message); ?></div>
                                            ...
                                            <div class="chat-input p-3 border-top">
                                                ...
                                                <form action="<?php echo e(route('customer.send-message')); ?>" id="contactForm" method="POST" enctype="multipart/form-data" class="d-flex flex-grow-1">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="sellerId" value="<?php echo e($sellerInfo->id); ?>">
...
<script>
    function redirectToChat(sellerId) {
        let url = "<?php echo e(route('customer.chat-with-seller', ':id')); ?>";
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function($) {
        ...
        $('#contactForm').on('submit', function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('customer.send-message')); ?>",
                data: formData,
                processData: false,
                contentType: false,
        ...
        function refreshChatContent() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(url('customer/chat/content')); ?>",
                data: {
        ...
        <?php if(isset($sellerInfo) && count($cmessages) > 0): ?>
