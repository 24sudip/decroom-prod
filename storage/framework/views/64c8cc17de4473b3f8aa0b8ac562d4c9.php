...
<?php $__env->startSection('content'); ?>
    <section id="quicktech-register" style="background: url('<?php echo e(asset('frontend/images/login.png')); ?>') no-repeat center / cover;">
        <div class="container">
                ...
                <div class="col-lg-8">
                    <div class="quikctech-register">
                        <div class="register-container">
                            ...
                            <form method="POST" action="<?php echo e(route('customer.register.submit')); ?>">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div id="pharmacy-fields" style="display: <?php echo e(old('type') == 'pharmacy' ? 'block' : 'none'); ?>;">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                       class="form-control <?php $__errorArgs = ['tread_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                       ...
                                                       value="<?php echo e(old('tread_no')); ?>">
                                                <?php $__errorArgs = ['tread_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               class="form-control <?php $__errorArgs = ['drug_licence_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                               ...
                                               value="<?php echo e(old('drug_licence_no')); ?>">
                                        <?php $__errorArgs = ['drug_licence_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mt-4 text-center">
                                    <p>Already have an account?
                                        <a href="<?php echo e(route('customer.login')); ?>" class="text-primary">Sign in</a>
                                    </p>
                                </div>
