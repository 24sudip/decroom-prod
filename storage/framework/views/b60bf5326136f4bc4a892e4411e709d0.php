<?php $__env->startSection('title', 'Seller Chat'); ?>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-0">
                ...
                <div class="quikctech-button-menu-profile mt-3">
                    <ul>
                        <li><a style="padding: 0px 10px;" class="ser-active" href="<?php echo e(route('vendor.profile')); ?>">Post</a></li>
                        ...
                        <li><a style="padding: 0px 10px;" class="ser-active" href="<?php echo e(route('vendor.profile.edit')); ?>">Edit Profile</a></li>
                    </ul>
                </div>
                ...
                <div class="quikctech-seller-message mt-4">
                    <div class="quikctech-chat-flex">
                        ...
                        <div class="quikctech-left sasc d-none d-lg-block">
                            ...
                            <div class="quikctech-list quikctech-conversation-list">
                                <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="quikctech-item <?php echo e(isset($customerInfo) && $customerInfo->id == $value->id ? 'active' : ''); ?>"
                                         data-conv-id="<?php echo e($value->id); ?>" onclick="redirectToChat('<?php echo e($value->name); ?>', <?php echo e($value->id); ?>)">
                                        <div class="quikctech-avatar">
                                            <img src="<?php echo e(asset($value->image)); ?>" alt="<?php echo e($value->name); ?>"
                                                 onerror="this.src='<?php echo e(asset('public/frontend/images/default-user.png')); ?>'" />
                                        </div>
                                        <div class="quikctech-meta">
                                            <div class="d-flex align-items-center">
                                                <div class="quikctech-title me-auto"><?php echo e($value->name); ?></div>
                                                <div class="quikctech-time">
                                                    <?php if(isset($value->last_message_time)): ?>
                                                        <?php echo e(\Carbon\Carbon::parse($value->last_message_time)->diffForHumans()); ?>

                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="quikctech-sub">
                                                <?php if(isset($value->last_message)): ?>
                                                    <?php echo e(strlen($value->last_message) > 30 ? substr($value->last_message, 0, 30) . '...' : $value->last_message); ?>
                        ...
                        <div class="quikctech-right">
                            <?php if(isset($smessages) && count($smessages) > 0): ?>
                                <div class="quikctech-header">
                                    <div class="quikctech-title-ribbon" id="quikctech-header-name">
                                        <?php echo e($customerInfo->name); ?>

                                    </div>
                                    <div class="quikctech-title-ribbon">
                                        <?php echo e($customerInfo->email ?? $customerInfo->phone); ?>

                                    </div>
                                    <div class="quikctech-title-ribbon">Id: <?php echo e($customerInfo->id); ?></div>
                                    <div class="quikctech-status" id="quikctech-header-status">
                                        <?php
                                            $customer = Auth::guard('customer')->user();
                                        ?>

                                        <?php if($customer && $customer->last_seen): ?>
                                            Active <?php echo e(\Carbon\Carbon::parse($customer->last_seen)->diffForHumans()); ?>
                                ...
                                <div class="quikctech-header">
                                    <div class="quikctech-title-ribbon"><?php echo e($customerInfo->address); ?></div>
                                </div>
                                <!-- Chat Body -->
                                <div class="quikctech-chatbody
                                " id="messageBottom">
                                    <?php $__currentLoopData = $smessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            ...
                                            <div class="quikctech-msg-row quikctech-msg-right">
                                                ...
                                                <div>
                                                    <?php if($value->file): ?>
                                                        <div class="file-preview">
                                                            <?php if(in_array(strtolower($fileExtension), $imageExtensions)): ?>
                                                                <img src="<?php echo e(asset('public/'.$value->file)); ?>" alt="Image"
                                                                    onerror="this.src='<?php echo e(asset('public/'.$value->file)); ?>'">
                                                            <?php else: ?>
                                                                <i class="fas fa-file fa-2x text-primary me-2"></i>
                                                            <?php endif; ?>

                                                            <div class="file-info">
                                                                <div class="file-size"><?php echo e($displaySize); ?></div>
                                                            </div>
                                                            <a href="<?php echo e(asset('public/'.$value->file)); ?>" download class="ms-2 text-decoration-none">
                                                    ...
                                                    <div class="quikctech-small-time">
                                                        <?php echo e(\Carbon\Carbon::parse($value->created_at)->format('h:i A')); ?>
                                ...
                                <div class="quikctech-inputbar">
                                    ...
                                    <form action="<?php echo e(route('vendor.send-message')); ?>" id="contactForm" method="POST" enctype="multipart/form-data" class="d-flex flex-grow-1">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="customerId" value="<?php echo e($customerInfo->id); ?>">
...
<script>
    function redirectToChat(name, customerId) {
        ...
        var url = '<?php echo e(url("vendor/me/seller/chat-withcustomer")); ?>/' + encodeURIComponent(name) + '/' + customerId;
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function($) {
        ...
        $('#contactForm').on('submit', function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('vendor.send-message')); ?>",
                data: formData,
                processData: false,
                contentType: false,
        ...
        function refreshChatContent() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(url('vendor/me/seller/chat/content')); ?>",
                data: {
        ...
        <?php if(isset($customerInfo) && count($smessages) > 0): ?>
