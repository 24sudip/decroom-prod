          ...
          <div class="col-lg-6">
            <div class="quikctech-profile-post mt-4">
              ...
              <div class="quikctech-post-seller-img">
                ...
                <div>
                  <?php if($service_draft && $service_draft->service_video): ?>
                    <video src="<?php echo e(asset($service_draft->service_video)); ?>" class="w-100" controls></video>
                  <?php elseif($service->service_video): ?>
                    <video src="<?php echo e(asset($service->service_video)); ?>" class="w-100" controls></video>
                  <?php elseif($service->catalog): ?>
                    <img src="<?php echo e(asset($service->catalog)); ?>" class="w-100" alt="<?php echo e($service->title); ?>">
                  <?php else: ?>
                ...
                <div class="col-lg-6 col-12">
                    <div class="quikctech-info-boxs">
                        ...
                        <div class="quikctech-info-content">
                            <?php if($service_draft): ?>
                            <div class="quicktech-p-cost">
                                <strong>Project cost:</strong> starts from
                                <b><?php echo e(number_format($service_draft->project_cost, 2)); ?> Tk.</b>
                            </div>
                            <div class="quicktech-p-r">
                                <strong>Service Charge:</strong> <?php echo e(number_format($service_draft->service_charge, 2)); ?> Tk.
                            </div>
                            <div class="quicktech-p-r">
                                <strong>Material Cost:</strong> <?php echo e(number_format($service_draft->material_cost, 2)); ?> Tk.
                            </div>
                            <div class="quicktech-p-r">
                                <strong>Delivery Duration:</strong>
                                <ul>
                                    <li><?php echo e($service_draft->delivery_duration ?? 'Not specified'); ?></li>
                                </ul>
                            </div>
                                <?php if($service_draft->discount): ?>
                                <div class="quicktech-p-r">
                                    <strong>Discount:</strong> <?php echo e(number_format($service_draft->discount, 2)); ?> Tk.
                                </div>
                                <?php endif; ?>
                            <?php else: ?>
                            <div class="quicktech-p-cost">
