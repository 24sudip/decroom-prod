...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container-fluid quikctech-dashboard">
            ...
            <div style="border-bottom:1px solid #0003; padding-bottom:30px;" class="row gapp my-4">
                <div class="col-md-4 col-sm-6">
                    <a href="<?php echo e(route('report.order.all')); ?>">
                ...
                <div class="col-md-4 col-sm-6">
                    <a href="<?php echo e(route('report.order.today')); ?>">
                        <div class="quikctech-card quikctech-cc">
                            <div class="quicktech-t-img">
                            ...
                            <div class="quicktech-t-text">
                                <h5>Today's Sales</h5>
                                <p>Tk <?php echo e($todayslSale ?? 0.0); ?></p>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-md-4 col-sm-6">
                    <a href="<?php echo e(route('report.order.all')); ?>">
                        <div class="quikctech-card quikctech-cc">
                            ...
                            <div class="quicktech-t-text">
                                <h5>Total Sales</h5>
                                <p>Tk <?php echo e($totalSale ?? 0.0); ?></p>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div style="border-bottom:1px solid #0003; padding-bottom:30px;" class="row quikctech-chart-container">
                ...
                <div class="col-lg-6">
                    <div class="menu-item">
                        <a href="<?php echo e(route('product.create')); ?>" class="item-button">
                            <span class="icon">+ Add New Product</span>
                            <span class="arrow"><i class="fa-solid fa-chevron-right"></i></span>
                        </a>
                    </div>
                    <div class="menu-item">
                        <a href="<?php echo e(route('report.order.all')); ?>" class="item-button">
                            <span class="icon">📝 View Orders</span>
                            <span class="arrow"><i class="fa-solid fa-chevron-right"></i></span>
                        </a>
                    </div>
                    <div class="menu-item">
                        <a href="<?php echo e(route('product.stock_warning')); ?>" class="item-button">
                            <span class="icon">⚠️ Low Stock Alert </span>
                            <span class="arrow"><i class="fa-solid fa-chevron-right"></i></span>
                        </a>
                    </div>
                    <div class="menu-item">
                        <a href="<?php echo e(route('expired.list')); ?>" class="item-button">
                ...
                <div class="col-lg-6">
                    <div class="row gapp">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <a href="<?php echo e(route('report.order.bytype', 'pending')); ?>">
                                <div class="quikctech-card quikctech-cc">
                                    <div class="quicktech-t-img">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <a href="<?php echo e(route('report.order.bytype', 'in-process')); ?>">
                                <div class="quikctech-card quikctech-cc">
                                    <div class="quicktech-t-img">
                                        <i class="fa-solid fa-boxes-stacked"></i>
                                    </div>
                                    <div class="quicktech-t-text">
                                        ...
                                        <p><?php echo e($processingOrder ?? 0); ?></p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <a href="<?php echo e(route('report.order.bytype', 'delivered')); ?>">
                                <div class="quikctech-card quikctech-cc">
                                    <div class="quicktech-t-img">
                                        <i class="fa-solid fa-boxes-stacked"></i>
                                    </div>
                                    <div class="quicktech-t-text">
                                        ...
                                        <p><?php echo e($deliveredOrder ?? 0); ?></p>
                                    </div>
                                </div>
                            </a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const monthlySalesData = <?php echo json_encode($monthlySalesData, 15, 512) ?>;
            const orderStatusData = <?php echo json_encode($orderStatusData, 15, 512) ?>;
