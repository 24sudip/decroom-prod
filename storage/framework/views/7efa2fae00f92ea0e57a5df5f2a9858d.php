...
<?php $__env->startSection('title', 'Post Service Edit'); ?>
...
<form action="<?php echo e(route('service-draft.update', $service_draft->id)); ?>" method="POST" class="quikctech-form-wrapper border p-4 rounded-3 shadow-sm" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                ...
                <option value="<?php echo e($service->id); ?>" <?php echo e($service->id == $service_draft->service_id ? 'selected' : ''); ?>><?php echo e($service->title); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
...
unset($__errorArgs, $__bag); ?>"
            placeholder="ex. Floor Epoxy" value="<?php echo e(old('title', $service_draft->title)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" placeholder="ex. next 3months / 45days" value="<?php echo e(old('delivery_duration', $service_draft->delivery_duration)); ?>">
...
unset($__errorArgs, $__bag); ?>" placeholder="Tk" value="<?php echo e(old('project_cost', $service_draft->project_cost)); ?>">
...
unset($__errorArgs, $__bag); ?>" placeholder="Material Cost" value="<?php echo e(old('material_cost', $service_draft->material_cost)); ?>">
...
unset($__errorArgs, $__bag); ?>" placeholder="Tk" value="<?php echo e(old('service_charge', $service_draft->service_charge)); ?>">
...
unset($__errorArgs, $__bag); ?>" placeholder="(Amount)Tk" value="<?php echo e(old('discount', $service_draft->discount)); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-4">
            ...
            <?php if($service_draft->service_video): ?>
                <div class="mb-2">
                    <p class="mb-1">Current Video:</p>
                    <a href="<?php echo e(asset($service_draft->service_video)); ?>" target="_blank"
