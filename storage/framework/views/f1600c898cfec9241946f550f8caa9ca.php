<?php echo $__env->yieldPushContent('scripts'); ?>
    ...
    <script src="<?php echo e(asset('frontend')); ?>/js/particles.min.js"></script>
    <script src="<?php echo e(asset('frontend')); ?>/js/particles.js"></script>
    <script src="<?php echo e(asset('frontend')); ?>/js/colorfulTab.min.js"></script>
    <script src="<?php echo e(asset('frontend')); ?>/js/waypoint.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>
    <script src="<?php echo e(asset('frontend')); ?>/js/jquery.counterup.js"></script>
...
<?php /**PATH E:\new-project-quick-tech\decroom-prod\resources\views/frontend/include/script.blade.php ENDPATH**/ ?>