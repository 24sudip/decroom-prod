...
<body>
    ...
    @php
        // Use the fully‑qualified facade to avoid import issues in Blade
    ...
    <div class="sidebar">
        <div class="accordion" id="accordionCategories">
            ...
            <div class="accordion-item bg-dark border-0">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed bg-dark text-white" data-bs-toggle="collapse"
                        data-bs-target="#healthcareCollapse">
                        <img src="images/medicine.png" style="height: 25px; padding-right:10px;" alt="">
                        Healthcare
                    </button>
                </h2>
                <div id="healthcareCollapse" class="accordion-collapse collapse"
                    data-bs-parent="#accordionCategories">
                    <div class="accordion-body ps-3">
                        <div class="accordion" id="healthcareSubcategories">

                            <!-- Subcategory: Devices -->
                            <div class="accordion-item bg-dark border-0">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed bg-dark text-white"
                                        data-bs-toggle="collapse" data-bs-target="#devicesCollapse">
                                        <img src="images/medicine.png" style="height: 25px; padding-right:10px;"
                                            alt=""> Devices
                                    </button>
                                </h2>
                                <div id="devicesCollapse" class="accordion-collapse collapse"
                                    data-bs-parent="#healthcareSubcategories">
                                    <div class="accordion-body ps-4">
                                        <a href="#" class="d-block text-white mb-1"><img
                                                src="images/medicine.png" style="height: 25px; padding-right:10px;"
                                                alt=""> Thermometers</a>
                                        <a href="#" class="d-block text-white mb-1"><img
                                                src="images/medicine.png" style="height: 25px; padding-right:10px;"
                                                alt=""> Blood Pressure Monitors</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item bg-dark border-0">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed bg-dark text-white"
                                        data-bs-toggle="collapse" data-bs-target="#personalCareCollapse">
                                        <img src="images/medicine.png" style="height: 25px; padding-right:10px;"
                                            alt=""> Personal Care
                                    </button>
                                </h2>
                                <div id="personalCareCollapse" class="accordion-collapse collapse"
                                    data-bs-parent="#healthcareSubcategories">
                                    <div class="accordion-body ps-4">
                                        <a href="#" class="d-block text-white mb-1"><img
                                                src="images/medicine.png" style="height: 25px; padding-right:10px;"
            ...
            <div class="accordion-item bg-dark border-0">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed bg-dark text-white" data-bs-toggle="collapse"
                        data-bs-target="#groceryCollapse">
                        <img src="images/medicine.png" style="height: 25px; padding-right:10px;" alt="">
                        Grocery
                    </button>
                </h2>
                <div id="groceryCollapse" class="accordion-collapse collapse" data-bs-parent="#accordionCategories">
                    <div class="accordion-body ps-3">
                        <div class="accordion" id="grocerySubcategories">

                            <!-- Subcategory: Fruits -->
                            <div class="accordion-item bg-dark border-0">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed bg-dark text-white"
                                        data-bs-toggle="collapse" data-bs-target="#fruitsCollapse">
                                        <img src="images/medicine.png" style="height: 25px; padding-right:10px;"
                                            alt=""> Fruits
                                    </button>
                                </h2>
                                <div id="fruitsCollapse" class="accordion-collapse collapse"
                                    data-bs-parent="#grocerySubcategories">
                                    <div class="accordion-body ps-4">
                                        <a href="#" class="d-block text-white mb-1"><img
                                                src="images/medicine.png" style="height: 25px; padding-right:10px;"
                                                alt=""> Apples</a>
                            ...
                            <div class="accordion-item bg-dark border-0">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed bg-dark text-white"
                                        data-bs-toggle="collapse" data-bs-target="#vegetablesCollapse">
                                        <img src="images/medicine.png" style="height: 25px; padding-right:10px;"
                                            alt=""> Vegetables
                                    </button>
                                </h2>
                                <div id="vegetablesCollapse" class="accordion-collapse collapse"
                                    data-bs-parent="#grocerySubcategories">
                                    <div class="accordion-body ps-4">
                                        <a href="#" class="d-block text-white mb-1"><img
                                                src="images/medicine.png" style="height: 25px; padding-right:10px;"
