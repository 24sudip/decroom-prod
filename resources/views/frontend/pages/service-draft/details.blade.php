          ...
          <div class="col-lg-6">
            <div class="quikctech-profile-post mt-4">
              ...
              <div class="quikctech-post-seller-img">
                ...
                <div>
                  @if($service_draft && $service_draft->service_video)
                    <video src="{{ asset($service_draft->service_video) }}" class="w-100" controls></video>
                  @elseif($service->service_video)
                    <video src="{{ asset($service->service_video) }}" class="w-100" controls></video>
                  @elseif($service->catalog)
                    <img src="{{ asset($service->catalog) }}" class="w-100" alt="{{ $service->title }}">
                  @else
                    ...
                    <div class="quikctech-info-boxs">
                        ...
                        <div class="quikctech-info-content">
                            ...
                            <div class="quicktech-p-cost">
                                ...
                                <b>{{ number_format($service_draft->project_cost, 2) }} Tk.</b>
                            </div>
                            <div class="quicktech-p-r">
                                <strong>Service Charge:</strong> {{ number_format($service_draft->service_charge, 2) }} Tk.
                            </div>
                            <div class="quicktech-p-r">
                                <strong>Material Cost:</strong> {{ number_format($service_draft->material_cost, 2) }} Tk.
                            </div>
                            <div class="quicktech-p-r">
                                <strong>Delivery Duration:</strong>
                                <ul>
                                    <li>{{ $service_draft->delivery_duration ?? 'Not specified' }}</li>
                                </ul>
                            </div>
                                @if($service_draft->discount)
                                <div class="quicktech-p-r">
                                    <strong>Discount:</strong> {{ number_format($service_draft->discount, 2) }} Tk.
                                </div>
                                @endif
                            @else
                            <div class="quicktech-p-cost">
