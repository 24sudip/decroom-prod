    ...
    <style>
      ...
      * {
      ...
      .bee-row-4 .bee-col-1 .bee-block-1 {
        color: #393d47;
        direction: ltr;
        font-family: "Roboto Slab", Arial, "Helvetica Neue", Helvetica,
          sans-serif;
        font-size: 44px;
        font-weight: 700;
        letter-spacing: 0;
	...
	<body>
		...
		<div class="bee-row bee-row-3">
			...
			<div class="bee-col bee-col-2 bee-col-w5">
				...
				<p>
					Lorem ipsum dolor sit amet, consectetur adipiscing elit.<br />Enim
					nisl, eget dictum consectetur integer lectus.
				</p>
				</div>
		...
		<div class="bee-row bee-row-5">
			...
			<div class="bee-col bee-col-2 bee-col-w8">
				<div class="bee-block bee-block-1 bee-paragraph">
				<p>
					<strong>Hello Sir </strong><br /><strong
					> {{ $schedule['heading'] }}</strong
					>
				</p>
				<h3> {{ $schedule['verifyToken'] }} </h3>
				<p>
					Aliquam purus commodo magnis ipsum dolor sit amet, consectetur
					adipiscing elit habitasse est in rhoncus libero ut. Aenean
					viverra fermentum, volutpat, neque amet, justo.<br />Socis
					natoqu eagnis dist mte dulmuese feugiata lecen erment.
				</p>
				</div>
		...
		<div class="bee-row bee-row-14">
			...
			<div class="bee-col bee-col-2 bee-col-w3">
				...
				>
					...
					<span style="font-size: 18px; line-height: 21px"
						><strong style=""
						><span style="line-height: 14px">About</span></strong
						></span
					>
					</p>
				</div>
				...
				>
					...
					<p style="line-height: 18px; text-align: center">
					<span style="line-height: 18px"
						>Aenean eget scelerisque magna.</span
					>
					</p>
					<p style="line-height: 18px; text-align: center">
					<span style="line-height: 18px"
						>Cras interdum do mattis eugravid. </span
					>
					</p>
				</div>
				</div>
			...
			<div class="bee-col bee-col-3 bee-col-w3">
				...
				>
					...
					<span style="font-size: 18px; line-height: 21px"
						><strong style=""
						><span style="line-height: 14px">Contact Us</span></strong
						></span
					>
					</p>
				</div>
				...
				>
					<p style="line-height: 18px; text-align: center">
					<span style="line-height: 18px"
						>Your Street 12, 34567 AB City</span
					>
					</p>
					<p style="line-height: 18px; text-align: center">
					<span style="line-height: 18px">info@example.com </span>
					</p>
					<p style="line-height: 18px; text-align: center">
					<span style="line-height: 18px">(+1) 123 456 789</span>
					</p>
				</div>
				</div>
			</div>
