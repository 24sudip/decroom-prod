                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="age" id="patientAge" value="{{ old('age') }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label">{{ __('Current Address ') }}<span
                                                            class="text-danger">*</span></label>
                                                    <textarea id="formmessage" name="address" class="form-control @error('address') is-invalid @enderror"
                                                        value="{{ old('address') }}" rows="3" placeholder="{{ __('Enter Current Address') }}"></textarea>
                                                    @error('address')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-12">
                                                    ...
                                                    <select class="form-control @error('gender') is-invalid @enderror"
                                                        name="gender">
                                                        <option hidden selected disabled>{{ __('-- Select Gender --') }}
                                                        </option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <select class="form-control @error('diet') is-invalid @enderror"
                                                        name="diet">
                                                        <option hidden selected disabled>{{ __('-- Select Diet --') }}
                                                        </option>
