...
@section('title', __('Vendor KYC List'))
    ...
    <div class="row">
        <div class="col-md-12 p-2">
            ...
            <div class="d-flex justify-content-between align-items-center py-2">
                <h5 class="title">Vendor KYC List</h5>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <table id="VisitorDt" 
                            ...
                            <thead>
                                <tr>
                                    <th class="text-center py-2" style="width: 10px">SL NO</th>
                                    <th class="py-2">Vendor Name</th>
                                    <th class="py-2">Email Address</th>
                                    <th class="py-2">Father's Name</th>
                                    <th class="py-2">Mother's Name</th>
                                    <th class="py-2">NID Front</th>
                                    <th class="py-2">NID Back</th>
                            ...
                            <tbody>
                                @forelse ($users as $user)
                                    <tr>
                                        ...
                                        <td class="py-2">
                                            @if($user->vendorDetails->email)
                                            {{ $user->vendorDetails->email }}
                                            @else
                                            {{ $user->email }}
                                            @endif
                                        </td>
                                        ...
                                        <td class="py-2">
                                            @if($user->vendorDetails->father_name)
                                            {{ $user->vendorDetails->father_name }}
                                            @else
                                            Not Submitted
                                            @endif
                                        </td>
                                        ...
                                        <td class="py-2">
                                            @if($user->vendorDetails->mother_name)
                                            {{ $user->vendorDetails->mother_name }}
                                            @else
                                            Not Submitted
                                            @endif
                                        </td>
                                        ...
                                        <td class="py-2">
                                            @if($user->vendorDetails->nid_front)
                                            <img src="{{ asset($user->vendorDetails->nid_front) }}" width="80">
                                            @else
                                            Not Submitted
                                            @endif
                                        </td>
                                        ...
                                        <td class="py-2 text-center">
                                            @if($user->vendorDetails->nid_back)
                                            <img src="{{ asset($user->vendorDetails->nid_back) }}" width="80">
                                            @else
                                            Not Submitted
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-center py-1">
                                            @if($user->image)
                                            <img src="{{ asset($user->image) }}" width="80">
                                            @else
                                            Not Submitted
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-center py-1">
                                            ...
                                            <form action="{{ route('admin.vendor-status-change', $user->id) }}" method="POST">
                                                @csrf 
                                                <div class="dropdown mt-1">
                                                  ...
                                                  <div class="dropdown-menu">
                                                    <button name="is_active" value="1" class="dropdown-item" type="submit">Active</button>
                                                    <button name="is_active" value="0" class="dropdown-item" type="submit">Inactive</button>
                                                  </div>
                                                </div>
                                            </form>
                                        </td>
