...
@section('title', 'Add Account Entry')

@section('content')
    <div class="container-fluid mt-4">
        <h4>Add Account Entry</h4>
        ...
        <form action="{{ route('account-entries.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-3">
                ...
                <select name="account_head_id" id="account_head_id" class="form-select" required>
                    ...
                    @foreach ($heads as $head)
                        <option value="{{ $head->id }}" {{ old('account_head_id') == $head->id ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <textarea name="note" id="editor" class="form-control">{{ old('note') }}</textarea>
            </div>
