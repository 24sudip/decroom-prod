...
@section('title')
    {{ __('Welcome Email For Default Credentials') }}
@endsection
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            <h5 class="text-primary">{{ AppSetting('title') }} - Hospital Management System
                                            </h5>
                        ...
                        <div class="mt-5 text-center">
                            <p>© {{ date('Y') }} {{ AppSetting('title') }}. Crafted with
                                <i class="mdi mdi-heart text-danger"></i> {{ __('by Themesbrand') }}
                            </p>
                        </div>
                    </div>
                </div>
