        ...
        <div class="col-12">
            ...
            @else
                <a href="{{ url('accountant') }}">
                    <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                        <i class="bx bx-arrow-back font-size-16 align-middle me-2"></i>{{ __('Back to Accountant List') }}
                    </button>
                </a>
            @endif
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form
                        action="@if ($accountant) {{ url('accountant/' . $accountant->id) }} @else {{ route('accountant.store') }} @endif"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                            tabindex="1" name="first_name" id="firstname"
                                            value="@if ($accountant) {{ $accountant->first_name }}@elseif(old('first_name')){{ old('first_name') }} @endif"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                                            ...
                                            value="@if ($accountant) {{ $accountant->email }}@elseif(old('email')){{ old('email') }} @endif"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                            ...
                                            value="@if ($accountant) {{ $accountant->last_name }}@elseif(old('last_name')){{ old('last_name') }} @endif"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <img class="@error('profile_photo') is-invalid @enderror"
                                            src="@if ($accountant && $accountant->profile_photo != null) {{ URL::asset('storage/images/users/' . $accountant->profile_photo) }}@else{{ URL::asset('build/images/users/noImage.png') }} @endif"
