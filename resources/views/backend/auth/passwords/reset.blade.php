                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" method="POST" action="{{ url('reset-password') }}">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="userpassword">{{ __('New Password') }} <span
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="userpassword">{{ __('Confirm Password') }} <span
                                                    class="text-danger">*</span></label>
                        ...
                        <div class="mt-5 text-center">
                            <p>{{ __('Remember It ?') }} <a href="{{ url('login') }}" class="fw-medium text-primary">
                                    {{ __('Sign In here') }}</a></p>
