                    ...
                    <form class="outer-repeater" action="{{ url('invoice/' . '' . $invoice_detail->id) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control select2 sel_patient @error('patient_id') is-invalid @enderror"
                                    name="patient_id" id="patient">
                                    <option disabled selected>{{ __('Select Patient') }}</option>
                                    @foreach ($patients as $patient)
                                        <option value="{{ $patient->id }}"
                                            {{ $invoice_detail->patient->id == $patient->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('payment_mode') is-invalid @enderror"
                                    ...
                                    <option value="Cash Payement" @if ($invoice_detail->payment_mode == 'Cash Payement') selected @endif>
                                        {{ __('Cash Payment') }}
                                    </option>
                                    <option value="Cheque" @if ($invoice_detail->payment_mode == 'Cheque') selected @endif>
                                        {{ __('Cheque') }}</option>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('payment_status') is-invalid @enderror"
                                    ...
                                    <option value="Paid" @if ($invoice_detail->payment_status == 'Paid') selected @endif>
                                        {{ __('Paid') }}</option>
                                    <option value="Unpaid" @if ($invoice_detail->payment_status == 'Unpaid') selected @endif>
                                        {{ __('Unpaid') }}</option>
                                </select>
                            ...
                            <div class="col-md-12">
                                <div class='repeater mb-4'>
                                    <div data-repeater-list="invoices" class="mb-3">
                                        <label>{{ __('Invoice Items ') }}<span class="text-danger">*</span></label>
