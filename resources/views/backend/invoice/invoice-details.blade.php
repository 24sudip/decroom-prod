                                ...
                                <select class="form-control select2 sel_patient @error('patient_id') is-invalid @enderror"
                                    ...
                                    @foreach ($patients as $patient)
                                        <option value="{{ $patient->id }}"
                                            @if (old('patient_id') == $patient->id) selected @endif>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('payment_mode') is-invalid @enderror"
                                    ...
                                    <option value="Cash Payement" @if (old('payment_mode') == 'Cash Payement') selected @endif>
                                        {{ __('Cash Payment') }}
                                    </option>
                                    <option value="Cheque" @if (old('payment_mode') == 'Cheque') selected @endif>
                                        {{ __('Cheque') }}</option>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('payment_status') is-invalid @enderror"
                                    ...
                                    <option value="Paid" @if (old('payment_status') == 'Paid') selected @endif>
                                        {{ __('Paid') }}</option>
                                    <option value="Unpaid" @if (old('payment_status') == 'Unpaid') selected @endif>
                                        {{ __('Unpaid') }}</option>
                                </select>
