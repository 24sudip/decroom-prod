    ...
    <script>
        $(function() {
            ...
            var table = $('#products-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('product.stock_out') }}',
                    data: function(d) {
                        d.category_id = $('select[name=category_id]').val();
                        d.brand_id = $('select[name=brand_id]').val();
                        d.generic_id = $('select[name=generic_id]').val(); // NEW
            ...
            $('#reset-filters').on('click', function() {
                $('select[name=category_id]').val(null).trigger('change');
                $('select[name=brand_id]').val(null).trigger('change');
                $('select[name=generic_id]').val(null).trigger('change');
